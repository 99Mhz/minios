...
void terminal_initialize(void) 
{
    ...
    terminal_buffer = VGA_MEMORY;size_t y;
...
{
    const size_t index = y * VGA_WIDTH + x;terminal_buffer[index] = make_vgaentry(c, color);
} 
...
{
    char c = (char)ic;
    terminal_write(&c, sizeof(c));return ic;
} 
